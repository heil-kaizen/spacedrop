...
export default function Docs() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-neutral-300 font-sans selection:bg-white/30 relative flex">
      ...
      {/* Sidebar Navigation */}
      <aside className="w-64 border-r border-[#1a1824] h-screen sticky top-0 flex-col pt-8 pb-8 z-10 hidden md:flex shrink-0 overflow-y-auto bg-transparent">
        <div className="px-6">
      ...
      {/* Main Content Pane */}
      <main className="flex-1 max-w-4xl px-8 md:px-20 py-24 md:py-24 z-10">
